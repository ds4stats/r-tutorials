...
Make one MAP following the points below:

* Restrict the `states` and `all.cities` files to only a few contiguous states, such as New York, Vermont, New Hampshire, Massachusetts, Rhode Island, and Connecticut.
...
* Color the cities so that state capitals are clearly differentiated from other cities.
